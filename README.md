...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nsbm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12507&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nsbm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nsbm` can be installed with:

```
conda install nsbm
```

It is possible to list all of the versions of `nsbm` available on your platform with:
